...
const Tooltip = ({ text, children }: TooltipProps) => {
  return (
    <div className="fixed bottom-20 z-50 right-40 flex">
      {children}
  ...
  return (
    <div className="group z-50 " >
      ...
      <Tooltip text="¿Necesitas ayuda? Conversa con Cupertino y recibe ayuda">
        <div className="fixed bottom-5 z-50 right-5 bg-blue-500 text-white w-12 h-12 rounded-full flex items-center justify-center cursor-pointer" onClick={toggleChatModal}>
          <span>Chat</span>
        </div>
      </Tooltip>
