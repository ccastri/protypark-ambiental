...
const Tooltip = ({ text, children }: TooltipProps) => {
  return (
    <div className="fixed bottom-20  z-40 right-40 flex">
      {children}
  ...
  return (
    <div className="group z-40   " >
      ...
      <Tooltip text="¿Necesitas ayuda? Conversa con Cupertino y recibe ayuda">
        <div className="fixed bottom-5 z-40 right-5 bg-blue-500 text-white w-12 h-12 rounded-full flex items-center justify-center cursor-pointer" onClick={toggleChatModal}>
          <span>Chat</span>
        </div>
      </Tooltip>
      ...
      {/* Chat modal */}
      {showChatModal && (
        <div className="fixed  bg-gray-800 bg-opacity-50 z-50 flex items-center justify-center">
